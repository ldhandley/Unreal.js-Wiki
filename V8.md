...
* Build 
 ...
 5. `gclient runhooks`
 6. `cd v8`
 7. `git remote add ncsoft https://github.com/ncsoft/v8; git fetch ncsoft; git checkout 6.1.534.9999`
 ...
 9. `ninja -C out/Release_X64 v8 v8_libbase v8_libplatform v8_libsampler v8_builtins_setup v8_builtins_generators`

* Build (MacOS)
 1. `fetch v8`
 2. `cd v8`
 3. `git remote add ncsoft https://github.com/ncsoft/v8; git fetch ncsoft; git checkout 6.1.534.9999`
