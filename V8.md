...
* For 5.3.332.19
 ...
 5. `gclient runhooks`
 6. `cd v8; git remote add ncsoft https://github.com/ncsoft/v8; git fetch ncsoft unreal.js; git checkout unreal.js'
 7. `python v8/gypfiles/gyp_v8 -Dtarget_arch=x64 -Dcomponent=shared_library -Dv8_enable_i18n_support=0 -Dwerror=no -Dv8_use_snapshot=false`
 8. `ninja -C out/Release_X64 v8`
...
* For >5.5.216
 ...
 7. `ninja -C out/Release_X64 v8 v8_libplatform v8_libsampler`
